...
from da_inc.provider import log, get_setting
...
class Filtering:
    ...
    def __init__(self):
        ...
        self.info = dict(title="", proxy_url="", internal_proxy_url="", da_inc_url="", titles=[])
        self.kodi_language = ''
    ...
    def use_general(self, provider, payload):
        ...
        Args:
            ...
            payload (dict): da_inc search payload
        """
